...
public class MainActivity extends AppCompatActivity {
    ...
    public static class SectionsFragment1 extends Fragment {
         ...
         * number.
         */
        public static SectionsFragment1 newInstance() {
    ...
    public static class SectionsFragment2 extends Fragment {
         ...
         * number.
         */
        public static SectionsFragment2 newInstance() {
    ...
    public static class SectionsFragment3 extends Fragment {
         ...
         * number.
         */
        public static SectionsFragment3 newInstance() {
    ...
    public static class SectionsFragment4 extends Fragment {
         ...
         * number.
         */
        public static SectionsFragment4 newInstance() {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            //return SectionsFragment1.newInstance();
            switch (position) {
                case 0:
                    return SectionsFragment1.newInstance();
                case 1:
                    return SectionsFragment2.newInstance();
                case 2:
                    return SectionsFragment3.newInstance();
                case 3:
                    return SectionsFragment4.newInstance();
                default:
                    return null;
            }
